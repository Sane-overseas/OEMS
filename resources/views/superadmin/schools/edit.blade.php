            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $school->name) }}"
                        required
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm py-2 px-3 transition" />
                </div>
                ...
                <div>
                    ...
                    <select name="is_active" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm py-2 px-3 transition">
                ...
                <div>
                    ...
                    <select name="type" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm py-2 px-3 transition">
                ...
                <div>
                    ...
                    <select name="board" class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm py-2 px-3 transition">
                ...
                <div class="md:col-span-3 space-y-2">
                    ...
                    <input type="file" id="logo" name="logo"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm py-2 px-3 transition bg-white"/>
                    @if ($school->logo)
                        <div class="mt-3">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm px-3 py-2 transition resize-none"
                ...
                <div>
                    ...
                    <input name="city" value="{{ old('city', $school->city) }}"
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 shadow-sm px-3 py-2 transition"/>
                </div>
