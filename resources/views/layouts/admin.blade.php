    ...
    <div class="fixed top-0 left-0 h-screen w-64 bg-gray-900 text-white flex flex-col z-50 transition-all duration-300">
        <div class="p-5 bg-white/5 border-b border-white/10 shrink-0">
            <div class="flex items-center justify-start">
                ...
                <div class="flex flex-col items-start min-w-0">
                    <span class="text-white font-bold text-lg mb-0.5 leading-tight break-all w-[150px] whitespace-nowrap overflow-hidden text-ellipsis" title="{{ auth()->user()?->school?->name }}">
                        {{ Str::limit(auth()->user()?->school?->name ?? 'ExamPlatform Pro', 22) }}
                    </span>
                    <span class="text-sm text-yellow-400 font-medium tracking-wide opacity-100 shadow-black drop-shadow-sm">
                        School Admin Panel
                    </span>
                </div>
            </div>
        ...
        <div class="flex-1 overflow-y-auto sidebar-scroll py-2">
            <ul class="flex flex-col space-y-1">
                ...
                <!-- Dashboard -->
                <li>
                    <a class="flex items-center justify-between px-5 py-3 text-gray-400 hover:bg-white/5 hover:text-white transition-colors border-l-4 border-transparent" href="{{ route('admin.dashboard') }}">
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            ...
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Batch Assignment</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Live Exam Monitor</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Student Camera Grid</a></li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Practice Exam</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Solution View</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Auto Evaluation</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Manual Checking</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Result Approval</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Scorecards</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Certificates</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">School Profile</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Branding</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Exam Rules</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Notification Settings</a></li>
                        </ul>
                    </div>
                </li>
                ...
                <li x-data="{ open: false }">
                    ...
                    <div x-show="open" x-collapse class="bg-black/20">
                        <ul class="flex flex-col py-1">
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Activity Logs</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Login History</a></li>
                            <li><a class="block px-5 py-2 pl-11 text-sm text-gray-400 hover:text-white hover:bg-white/10" href="#">Violation Logs</a></li>
                        </ul>
                    </div>
                </li>
