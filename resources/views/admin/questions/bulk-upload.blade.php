...
<div class="max-w-3xl mx-auto space-y-8">
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow">
        <div class="p-8">
            ...
            <form method="POST" action="{{ route('admin.questions.bulk.upload') }}" enctype="multipart/form-data" class="space-y-8">
                @csrf
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-5 text-sm text-gray-800">
                    <div class="flex flex-wrap justify-between items-center mb-2">
                        ...
                        <a href="{{ route('admin.questions.bulk.sample') }}" class="text-indigo-600 hover:underline text-xs font-semibold">
                            Download Sample CSV
                        </a>
                    </div>
