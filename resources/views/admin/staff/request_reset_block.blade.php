            ...
            <div class="bg-gray-100 px-6 py-4 border-b">
                <h5 class="text-xl font-bold text-blue-600 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 11c0-3.185 2.185-6 6-6s6 2.815 6 6-2.185 6-6 6-6-2.815-6-6zM15 19l1-7" />
                    </svg>
                            ...
                            <label class="flex items-center cursor-pointer group">
                                ...
                                <div class="px-4 py-2 rounded-lg border-2 border-gray-200 group-hover:border-red-500 peer-checked:border-red-600 peer-checked:bg-red-50 flex items-center gap-2 transition">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364a9 9 0 11-12.728-12.728 9 9 0 0112.728 12.728z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16.243 7.757l-8.486 8.486" />
                                    </svg>
                                    Block User
                                </div>
                            </label>
