            ...
            <div class="px-8 py-6 border-b border-gray-100 flex items-center justify-between">
                <h2 class="text-2xl font-bold text-blue-600 flex items-center gap-2">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 20v-2a4 4 0 00-3-3.87M6 20v-2a4 4 0 013-3.87m9-9.13A4 4 0 1115 7a4 4 0 014 4zm-9 0A4 4 0 114 7a4 4 0 014 4zm3 5a4 4 0 016 0v2a4 4 0 01-4 4H9a4 4 0 01-4-4v-2a4 4 0 016-0z"/>
                    </svg>
                    Add New Student
                </h2>
            ...
            <div class="p-8">
                ...
                <form action="{{ route('admin.students.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                    ...
                    <section>
                        ...
                        <div class="flex flex-col md:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <input type="text" id="grade" name="grade" value="{{ old('grade') }}" placeholder="e.g. 10th"
                    ...
                    <div class="flex justify-end gap-4 pt-8">
                        <button type="reset" class="px-6 py-2 bg-gray-100 text-gray-700 font-medium rounded hover:bg-gray-200 border border-gray-300 transition-colors">
                            Reset
                        </button>
